"""
Django settings for broken_flower_dev_98761 project.
...
ROOT_URLCONF = 'broken_flower_dev_98761.urls'
...
WSGI_APPLICATION = 'broken_flower_dev_98761.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_flower_dev_98761 API",
    "DESCRIPTION": "API documentation for broken_flower_dev_98761 App",
    "VERSION": "v1",
}
